...
class DocumentPipeline:
    ...
    def ingest(self, document: models.Document, content: bytes, filename: str) -> models.DocumentVersion:
        ...
        version = models.DocumentVersion(document_id=document.id, version=version_number, content_hash=digest, original_path=str(original_path), normalized_path=str(normalized_path), normalized_markdown=normalized, extraction_metadata=extraction, status="NORMALIZADO")
