...
**Versão:** 2.0 — Business + Arquitetura MVP Consolidada  
...
```text
              ...
              │                               │
           FRONTEND                         API
        React + TypeScript              Java 21 / Spring
              │                               │
              └───────────────┬───────────────┘
                              │
                       DOMAIN / CORE
...
A arquitetura do MVP está considerada **fechada para início da implementação**.
...
A partir desta versão, novas ideias não devem bloquear o MVP.
